...
urlpatterns += i18n_patterns('',
    # NeuroCity home
    url(r'^$', home_view, name='nc_home'),
    url(r'^learn$', learn_view, name='nc_learn'),
    ...
    url(r'^matchonly$', matchonly_view, name='nc_matchonly'),
    url(r'^vote$', 'catmaid.control.segment.vote'),
    ...
    url(r'^maxlimit$', maxlimit, name='maxlimit'),
