...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SegmentVote.project'
        db.delete_column('catmaid_segmentvote', 'project_id')


    def backwards(self, orm):
        # Adding field 'SegmentVote.project'
        db.add_column('catmaid_segmentvote', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catmaid.Project']),
                      keep_default=False)
