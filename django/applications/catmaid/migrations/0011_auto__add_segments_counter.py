...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Segments.good_counter'
        db.add_column('catmaid_segments', 'good_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Segments.bad_counter'
        db.add_column('catmaid_segments', 'bad_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Segments.good_counter'
        db.delete_column('catmaid_segments', 'good_counter')

        # Deleting field 'Segments.bad_counter'
        db.delete_column('catmaid_segments', 'bad_counter')
