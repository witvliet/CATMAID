...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SegmentComment.comment'
        db.add_column('catmaid_segmentcomment', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SegmentComment.comment'
        db.delete_column('catmaid_segmentcomment', 'comment')
