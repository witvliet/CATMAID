...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SliceSegmentMap'
        db.create_table('catmaid_slicesegmentmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Slices'])),
            ('slice_node_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('segment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Segments'])),
            ('segment_node_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('direction', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
        ))
        db.send_create_signal('catmaid', ['SliceSegmentMap'])


    def backwards(self, orm):
        # Deleting model 'SliceSegmentMap'
        db.delete_table('catmaid_slicesegmentmap')
