...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SliceSegmentMap.segmenttype'
        db.add_column('catmaid_slicesegmentmap', 'segmenttype',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SliceSegmentMap.segmenttype'
        db.delete_column('catmaid_slicesegmentmap', 'segmenttype')
