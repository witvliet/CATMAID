...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EndSegmentToConstraintMap'
        db.create_table('catmaid_endsegmenttoconstraintmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stack', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Stack'])),
            ('endsegment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.EndSegments'])),
        ...
        db.send_create_signal('catmaid', ['EndSegmentToConstraintMap'])

        # Adding field 'ConstraintsToSegmentMap.endsegments'
        db.add_column('catmaid_constraintstosegmentmap', 'endsegments',
                      self.gf('catmaid.fields.IntegerArrayField')(default=None, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EndSegmentToConstraintMap'
        db.delete_table('catmaid_endsegmenttoconstraintmap')

        # Deleting field 'ConstraintsToSegmentMap.endsegments'
        db.delete_column('catmaid_constraintstosegmentmap', 'endsegments')
    ...
    models = {
        ...
        'catmaid.constraintstosegmentmap': {
            ...
            'endsegments': ('catmaid.fields.IntegerArrayField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'segments': ('catmaid.fields.IntegerArrayField', [], {'blank': 'True'})
        },
        'catmaid.dataview': {
        ...
        'catmaid.endsegmentsdata': {
            'Meta': {'object_name': 'EndSegmentsData'},
            ...
            'segment': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['catmaid.EndSegments']", 'unique': 'True', 'primary_key': 'True'}),
            'size': ('django.db.models.fields.FloatField', [], {'default': '0.0'})
        },
        'catmaid.endsegmenttoconstraintmap': {
            'Meta': {'object_name': 'EndSegmentToConstraintMap'},
            'constraint': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.ConstraintsToSegmentMap']"}),
            'endsegment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.EndSegments']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sectionindex': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'stack': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.Stack']"})
        },
        ...
        'catmaid.segments': {
            ...
            'assembly': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.ClassInstance']", 'null': 'True'}),
            'bad_counter': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'center_x': ('django.db.models.fields.FloatField', [], {'db_index': 'True'}),
            'center_y': ('django.db.models.fields.FloatField', [], {'db_index': 'True'}),
            'cost': ('django.db.models.fields.FloatField', [], {'db_index': 'True'}),
            'direction': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'good_counter': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'catmaid.slicesegmentmap': {
            'Meta': {'object_name': 'SliceSegmentMap'},
            'direction': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'segment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.Segments']"}),
            'segment_node_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'slice': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.Slices']"}),
            'slice_node_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'})
        },
        'catmaid.stack': {
