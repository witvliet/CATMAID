...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SegmentVote.elapsed_time'
        db.add_column('catmaid_segmentvote', 'elapsed_time',
        ...
        # Adding field 'Segments.center_y'
        # db.add_column('catmaid_segments', 'center_y',
        #               self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
        #               keep_default=False)

        # # Adding field 'Segments.center_x'
        # db.add_column('catmaid_segments', 'center_x',
        #               self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
        #               keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # # Adding field 'Segments.max_slice_distance'
        # db.add_column('catmaid_segments', 'max_slice_distance',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.aligned_average_slice_distance'
        # db.add_column('catmaid_segments', 'aligned_average_slice_distance',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.set_difference'
        # db.add_column('catmaid_segments', 'set_difference',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.aligned_overlap_ratio'
        # db.add_column('catmaid_segments', 'aligned_overlap_ratio',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.overlap_ratio'
        # db.add_column('catmaid_segments', 'overlap_ratio',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_8'
        # db.add_column('catmaid_segments', 'histogram_8',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_9'
        # db.add_column('catmaid_segments', 'histogram_9',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_4'
        # db.add_column('catmaid_segments', 'histogram_4',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_5'
        # db.add_column('catmaid_segments', 'histogram_5',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_6'
        # db.add_column('catmaid_segments', 'histogram_6',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_7'
        # db.add_column('catmaid_segments', 'histogram_7',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_0'
        # db.add_column('catmaid_segments', 'histogram_0',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_1'
        # db.add_column('catmaid_segments', 'histogram_1',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_2'
        # db.add_column('catmaid_segments', 'histogram_2',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.histogram_3'
        # db.add_column('catmaid_segments', 'histogram_3',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.center_distance'
        # db.add_column('catmaid_segments', 'center_distance',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.average_slice_distance'
        # db.add_column('catmaid_segments', 'average_slice_distance',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.aligned_set_difference'
        # db.add_column('catmaid_segments', 'aligned_set_difference',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_3'
        # db.add_column('catmaid_segments', 'normalized_histogram_3',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.aligned_overlap'
        # db.add_column('catmaid_segments', 'aligned_overlap',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.overlap'
        # db.add_column('catmaid_segments', 'overlap',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.set_difference_ratio'
        # db.add_column('catmaid_segments', 'set_difference_ratio',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.size'
        # db.add_column('catmaid_segments', 'size',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_7'
        # db.add_column('catmaid_segments', 'normalized_histogram_7',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_6'
        # db.add_column('catmaid_segments', 'normalized_histogram_6',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_5'
        # db.add_column('catmaid_segments', 'normalized_histogram_5',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_4'
        # db.add_column('catmaid_segments', 'normalized_histogram_4',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_2'
        # db.add_column('catmaid_segments', 'normalized_histogram_2',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_1'
        # db.add_column('catmaid_segments', 'normalized_histogram_1',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_0'
        # db.add_column('catmaid_segments', 'normalized_histogram_0',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.aligned_max_slice_distance'
        # db.add_column('catmaid_segments', 'aligned_max_slice_distance',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_9'
        # db.add_column('catmaid_segments', 'normalized_histogram_9',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Adding field 'Segments.normalized_histogram_8'
        # db.add_column('catmaid_segments', 'normalized_histogram_8',
        #               self.gf('django.db.models.fields.FloatField')(default=0),
        #               keep_default=False)

        # # Deleting field 'Segments.center_y'
        # db.delete_column('catmaid_segments', 'center_y')

        # # Deleting field 'Segments.center_x'
        # db.delete_column('catmaid_segments', 'center_x')
