...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Segments.creation_time'
        db.delete_column('catmaid_segments', 'creation_time')

        # Deleting field 'Segments.user'
        db.delete_column('catmaid_segments', 'user_id')

        # Deleting field 'Segments.edition_time'
        db.delete_column('catmaid_segments', 'edition_time')

        # Deleting field 'Segments.project'
        db.delete_column('catmaid_segments', 'project_id')


    def backwards(self, orm):
        # Adding field 'Segments.creation_time'
        db.add_column('catmaid_segments', 'creation_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Segments.user'
        db.add_column('catmaid_segments', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Segments.edition_time'
        db.add_column('catmaid_segments', 'edition_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Segments.project'
        db.add_column('catmaid_segments', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['catmaid.Project']),
                      keep_default=False)
