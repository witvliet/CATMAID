...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SliceSegmentMap.segment'
        db.delete_column('catmaid_slicesegmentmap', 'segment_id')

        # Adding field 'SliceSegmentMap.segment_id'
        db.add_column('catmaid_slicesegmentmap', 'segment_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SliceSegmentMap.segment'
        db.add_column('catmaid_slicesegmentmap', 'segment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catmaid.Segments']),
                      keep_default=False)

        # Deleting field 'SliceSegmentMap.segment_id'
        db.delete_column('catmaid_slicesegmentmap', 'segment_id')
    ...
    models = {
        ...
        'catmaid.slicesegmentmap': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'segment_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
