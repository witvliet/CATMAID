...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EndSegments'
        db.create_table('catmaid_endsegments', (
        ...
        db.send_create_signal('catmaid', ['EndSegments'])

        # Adding model 'EndSegmentsData'
        db.create_table('catmaid_endsegmentsdata', (
            ('segment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['catmaid.EndSegments'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('catmaid', ['EndSegmentsData'])


    def backwards(self, orm):
        # Deleting model 'EndSegments'
        db.delete_table('catmaid_endsegments')

        # Deleting model 'EndSegmentsData'
        db.delete_table('catmaid_endsegmentsdata')
