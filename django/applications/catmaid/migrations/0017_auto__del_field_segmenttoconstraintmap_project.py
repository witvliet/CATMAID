...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SegmentToConstraintMap.project'
        db.delete_column('catmaid_segmenttoconstraintmap', 'project_id')


    def backwards(self, orm):
        # Adding field 'SegmentToConstraintMap.project'
        db.add_column('catmaid_segmenttoconstraintmap', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catmaid.Project']),
                      keep_default=False)
