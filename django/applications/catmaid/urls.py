...
urlpatterns += patterns('catmaid.control.connector',
    ...
    (r'^(?P<project_id>\d+)/connector/join$', 'join_connectors'),
    (r'^(?P<project_id>\d+)/connector/split$', 'split_connectors'),
)
...
urlpatterns += patterns('catmaid.control.skeleton',
    ...
    (r'^(?P<project_id>\d+)/skeleton/(?P<skeleton_id>\d+)/updateneuronname$', 'updateneuronname'),
